...
const ICONS = {
  ...
  sparkle: '<path d="M12 3c.6 3 1.6 4.4 5 5-3.4.6-4.4 2-5 5-.6-3-1.6-4.4-5-5 3.4-.6 4.4-2 5-5Z"/><path d="M19 3.5c.3 1.4.8 2 2.2 2.3-1.4.3-1.9.9-2.2 2.3-.3-1.4-.8-2-2.2-2.3 1.4-.3 1.9-.9 2.2-2.3Z"/><path d="M6 15c.25 1.1.65 1.6 1.8 1.9-1.15.3-1.55.8-1.8 1.9-.25-1.1-.65-1.6-1.8-1.9 1.15-.3 1.55-.8 1.8-1.9Z"/>',
